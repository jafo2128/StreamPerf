...
Timer* timer_create( struct timeval* nowP, TimerProc* timer_proc,
...
struct timeval* timer_timeout( struct timeval* nowP )
{
    struct timeval now;
    int64_t usecs;
...
void timer_run( struct timeval* nowP )
{
    struct timeval now;
    Timer* t;
    Timer* next;
...
void timer_reset( struct timeval* nowP, Timer* t )
{
    struct timeval now;
